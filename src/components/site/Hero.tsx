      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className="grid lg:grid-cols-[1.05fr_1fr] gap-10 lg:gap-14 items-center">
          <div className="relative">
            ...
            <h1 className="mt-5 font-display text-[2.5rem] sm:text-5xl lg:text-[4rem] leading-[1.05] font-bold text-foreground">
          ...
          <div className="relative">
            <div className="relative rounded-[2rem] overflow-hidden shadow-glow">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-tr from-[#1c17de]/40 via-transparent to-transparent" />
            </div>

            {/* Floating cards */}
            <div className="absolute -left-4 md:-left-10 top-10 glass rounded-2xl p-4 shadow-soft animate-float w-[180px]">
            ...
            <div className="absolute -right-2 md:-right-6 top-40 glass rounded-2xl p-4 shadow-soft animate-float-slow w-[200px]">
            ...
            <div className="absolute -bottom-6 left-6 md:left-10 glass rounded-2xl p-4 shadow-soft animate-float w-[230px]">
